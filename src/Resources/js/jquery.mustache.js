...
(function ($, window) {
    ...
    var templateMap = {},
        ...
        options = {
            ...
            // Specifies the `dataType` attribute used when external template are loaded.
     ...
     *
     * @param [...templateElementIds]	List of element id's present on the DOM which contain template to be added;
    ...
    /**
     * Removes all template and tells Mustache to flush its cache.
     */
    function clear() {
        templateMap = {};
    ...
    /**
     * Loads the external Mustache template located at the supplied URL and registers them for later use.  This method
     ...
     * @param onComplete	Optional callback function which will be invoked when the template from the supplied URL
     *						have been loaded and are ready for use.
     * @returns				jQuery deferred promise which will complete when the template have been loaded and are
     *						ready for use.
     */
